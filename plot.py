...
subplot_config = [
[0,0],[1,1],[1,2],[1,3],[2,2],[1,5],[2,3],[2,4],[2,4],[3,3],
[2,5],[2,6],[3,4],[3,5],[3,5],[3,5],[4,4],[3,6],[3,6],[3,7],
[3,7],[3,7],[3,8],[3,8],[3,8],[3,9],[3,9],[3,9],[3,10],[3,10],
[3,10],[4,8],[4,8],[4,9],[4,9],[4,9],[4,9],[4,10],[4,10],[4,10],
[4,10],[5,9],[5,9],[5,9],[5,9],[5,9],[5,10],[5,10],[5,10],[5,10],[5,10]]
...
def plot(chronology):
	...
	for p in chronology:
		...
		plt.subplot(subplot_config[len(chronology)][0], subplot_config[len(chronology)][1], index)

		#imprime linha fixa do limite da mochila
		plt.plot(np.full(y_limit+3,config.knapsackCapacity),np.arange(y_limit+3))
