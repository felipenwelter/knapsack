...
class Population:
    ...
    def __init__(self):
        ...
        self.weightAverage = 0 #a média de peso dos indivíduos da população (informativo)
        self.procreateMethod = config.procreateMethod # método de procriação (geração de nova população)
